import { ImageProvider } from "components/context/Auth-Context";
...
const Detailpage = () => {
  ...
  console.log(
    "🚀 ~ file: Detailpage.js ~ line 15 ~ Detailpage ~ valuesTotal",
    valuesTotal
  );
  return (
    <ImageProvider images={item.images} totalValues={valuesTotal}>
