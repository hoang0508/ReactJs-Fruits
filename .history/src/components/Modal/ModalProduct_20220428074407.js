...
const ModalProduct = ({ urlM, setShow }) => {
  console.log(
    "🚀 ~ file: ModalProduct.js ~ line 10 ~ ModalProduct ~ setShow",
    setShow
  );
  // urlM, api
  ...
  const [currenImage, setCurrentImage] = useState(item.images);
  console.log(
    "🚀 ~ file: ModalProduct.js ~ line 26 ~ ModalProduct ~ currenImage",
    currenImage
  );
  return (
