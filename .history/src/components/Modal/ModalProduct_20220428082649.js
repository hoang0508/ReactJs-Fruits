...
const ModalProduct = ({ urlM, setShow }) => {
  // urlM, api
  ...
  console.log(
    "🚀 ~ file: ModalProduct.js ~ line 27 ~ ModalProduct ~ currentImage",
    currentImage
  );
  const handleCurrentImages = () => {
    setCurrentImage(itemImages);
  };
  return (
